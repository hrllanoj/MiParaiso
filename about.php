                ...
                <div class="col-lg-6">
                    <div class="row g-2">
                        <div class="col-6 wow fadeIn" data-wow-delay="0.1s">
                            <img class="img-fluid rounded" src="img/banner-1.jpg">
                        </div>
                        <div class="col-6 wow fadeIn" data-wow-delay="0.1s">
                            <img class="img-fluid rounded" src="img/gallery-4.jpg">
                        </div>
                        <div class="col-6 wow fadeIn" data-wow-delay="0.3s">
                            <img class="img-fluid rounded" src="img/service-2.jpg">
                        </div>
                        <div class="col-6 wow fadeIn" data-wow-delay="0.5s">
                            <img class="img-fluid rounded" src="img/gallery-6.jpg">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <p class="section-title bg-white text-start text-primary pe-3">Sobre Nosotros</p>
                    <h1 class="mb-4">Una parte de nuestra historia</h1>
                    <p class="mb-4">En Finca - Mi Paraíso, hemos tejido una historia de pasión y dedicación en el mundo de la ganadería. Nuestro legado se ha forjado a lo largo de generaciones, enraizado en la tierra y en el amor por nuestros animales. Desde la brisa fresca de la mañana hasta el cálido anochecer, cada día en nuestra finca refleja el compromiso incansable con la excelencia y el bienestar animal.</p>
                    <p class="mb-4">Nos encontramos en el cruce entre la tradición y la modernidad. Hemos heredado las enseñanzas de nuestros ancestros, honrando su sabiduría en el cuidado del ganado y en la conexión con la naturaleza. Al mismo tiempo, abrazamos la innovación y las mejores prácticas agrícolas para criar un ganado de la más alta calidad genética y salud.</p>
                    <p class="mb-4">En Finca - Mi Paraíso, nuestros animales son más que solo ganado; son parte de nuestra familia. Cada uno recibe atención individualizada, un entorno enriquecedor y un trato respetuoso que refleja nuestro compromiso con el bienestar animal. Creemos que esta ética de cuidado se traduce directamente en la calidad de nuestros productos ganaderos.</p>
                    <p class="mb-4">Nuestra finca es un lugar donde los sueños ganaderos se transforman en realidad. Ya sea que busques mejorar tu rebaño, encontrar ejemplares excepcionales para cría o asegurar una inversión sólida en la industria ganadera, estamos aquí para guiar y apoyar cada paso de tu camino.</p>
                    <p class="mb-4">Ven y experimenta Finca - Mi Paraíso por ti mismo. Nuestro equipo apasionado está ansioso por compartir su conocimiento, responder tus preguntas y ayudarte a encontrar las soluciones ganaderas que se ajusten a tus necesidades únicas.</p>
                    <p class="mb-4">En Finca - Mi Paraíso, no solo estamos comprometidos con el presente, sino también con el futuro de la ganadería. Te damos la bienvenida a un lugar donde la tradición, la excelencia y el respeto se fusionan para crear un auténtico paraíso ganadero.</p>
