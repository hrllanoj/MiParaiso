...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO historial_salud_tratamientos(id, id_animal, fecha, tipo_tratamiento, detalles) VALUES (NULL, :id_animal ,NOW(), :tipo_tratamiento, :detalles)";
    ...
    if ($stmt->execute()) {
        ...
        $message = 'Lo sentimos, no pudimos crear el tratamiento';
    }
}
            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mb-3">Estadísticas de Salud</h4>
                    ...
                    <script>
                        <?php
                            ...
                            $query = "SELECT tipo_tratamiento, COUNT(*) AS cantidad FROM historial_salud_tratamientos GROUP BY tipo_tratamiento";
                            ...
                            while ($row = mysqli_fetch_assoc($resultado)) {
                                $dataLabels[] = $row["tipo_tratamiento"];
                        ...
                        var ctx = document.getElementById('saludChart').getContext('2d');
                        var saludChart = new Chart(ctx, {
                            type: 'bar',
                            data: datosCompras,
                            options: {
                                scales: {
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header"><small>Registrar Nuevo</small><strong> Tratamiento</strong></div>
                                <div class="card-body card-block">
                                        <form action="salud.php" method="POST">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <div class="input-group-addon">Tipo de Tratamiento
                                                    :</div>
                                                    <select name="tipo_tratamiento" class='form-control' id="tipo_tratamiento">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input name="id_animal" class="form-control" type="number" id="id_animal" value="id_animal"   placeholder="Ingrese el id del animal" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                            ...
                                            <div class="form-actions form-group"><button type="submit" value="Registrar Tratamiento" class="btn btn-success btn-sm">Registrar Tratamiento</button></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <?php
                                            ...
                                            $resultados=$enlace->query("SELECT * FROM historial_salud_tratamientos");//selecciona todos los productos de la tabla detalle venta
                                            $consulta="SELECT * FROM historial_salud_tratamientos"; //selecciona todos los productos de la tabla detalle venta
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $fila['tipo_tratamiento'];?></td>
