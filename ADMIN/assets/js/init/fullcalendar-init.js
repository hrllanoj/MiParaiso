...
!function($) {
    ...
    CalendarApp.prototype.saveEventToDatabase = function(eventObj) {
        var $this = this;
        var eventData = {
            title: eventObj.title,
            start: eventObj.start.format(),
            end: eventObj.end.format(),
            className: eventObj.className[0]
        };
    
        $.ajax({
            url: 'save_event.php', // Ruta al archivo PHP para guardar eventos en la base de datos
            type: 'POST',
            data: eventData,
            success: function(response) {
                console.log(response); // Puedes mostrar un mensaje en la consola
            },
